Now I have everything I need. The feedback has exactly one issue: Test 5 uses the vague term "various plies" instead of specifying exact plies. Let me produce the revised plan.
