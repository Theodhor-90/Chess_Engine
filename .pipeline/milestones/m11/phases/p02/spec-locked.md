...
- Benchmark results (perft speeds, search NPS, nodes per second at fixed depth, time-to-depth figures)
...
**Deliverable**: `ARCHITECTURE.md` at the repository root explaining design decisions, data structures, and search algorithms.
...
- `ARCHITECTURE.md` — contributor-facing design and algorithm documentation at the repository root
