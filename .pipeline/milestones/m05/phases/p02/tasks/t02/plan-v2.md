Now I have all the context. The feedback has a single issue: Test 2 (`iid_does_not_trigger_below_threshold`) presents two alternative assertion strategies without committing to one. I need to pick one concrete approach and remove the ambiguity.
