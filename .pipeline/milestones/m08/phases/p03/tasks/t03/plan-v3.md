Good — the openings file exists. Now I have all the context needed. Let me produce the revised plan addressing all feedback issues.
...
- **Existing project artifacts**: The `tools/selfplay/openings.txt` file (EPD format opening positions created in P01). This file is committed to the repository and will be available at checkout via `actions/checkout`.
