Good. Now I have all the context I need. The feedback is clear and narrow: remove exit criterion #4 because it restates global CI conventions that the pipeline already enforces. Everything else in the spec was approved. Here is the revised specification:
