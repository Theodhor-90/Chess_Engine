I have all the information I need. Let me now produce the milestone specification.
...
- `perft` function and test suite validating against standard positions (starting position, Kiwipete, and others) to depth 5+
...
4. `perft` results match known reference counts for standard test positions (starting position, Kiwipete, and additional published positions) to depth 5+.
