...
- Unit tests verifying:
  ...
  - At least 3 middlegame positions: `r1bqkbnr/pppppppp/2n5/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 1 2` (Alekhine's Defense), `r1bqkb1r/pppppppp/2n2n2/8/2B1P3/5N2/PPPP1PPP/RNBQK2R b KQkq - 3 3` (Italian-like), `rnbqk2r/pppp1ppp/4pn2/8/1bPP4/2N5/PP2PPPP/R1BQKBNR w KQkq - 2 4` (Nimzo-Indian)
  - At least 2 endgame positions: `8/8/4k3/8/8/4K3/4P3/8 w - - 0 1` (king+pawn vs king), `8/5k2/8/8/8/2K5/8/4R3 w - - 0 1` (rook endgame)
  - Round-trip property: `Position::from_fen(fen).to_fen() == fen` for all of the above canonical FEN strings
  - Rejection of malformed FEN strings (wrong field count, invalid piece placement, invalid active color, invalid castling, out-of-range clocks)
