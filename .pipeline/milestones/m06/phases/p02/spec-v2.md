Now I have everything I need. Let me produce the revised specification, addressing all four feedback issues:

1. **Format**: Remove the preamble artifact line
2. **Ambiguity (SEE tests)**: Replace "various piece combinations" with specific test cases
3. **Ambiguity (history aging)**: Commit to a specific aging mechanism instead of "e.g."
4. **Scope**: Remove the generic "all existing tests pass" exit criterion
