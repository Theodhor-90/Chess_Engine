...
- A selection interface that accepts the mode as a parameter and delegates to the appropriate strategy
...
- Polyglot Zobrist key constants and hashing module
- Polyglot book entry struct and `.bin` file parser
- Polyglot-to-engine move translation function
- Book move selection module (`bestmove` and `weighted` modes)
- UCI option definitions for book path and mode
- Engine loop modification for book consultation
