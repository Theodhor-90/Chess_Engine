I have all the context I need. Let me produce the revised specification addressing both feedback issues: (1) replace the vague "appropriate" wording in T02 with explicit delegation logic, and (2) remove the redundant "Artifacts" section.
