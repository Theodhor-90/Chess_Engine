Now I have full context. The feedback has a single issue: exit criterion #9 restates global CI conventions and should be removed. The v2 draft has this criterion while v1 already didn't have it. I need to produce a revised spec that removes criterion #9 and keeps everything else.
